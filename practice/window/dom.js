/**
 * DOM:is a tree-like representation of the html document.it provides a way to interact with html document using javascript.
 * the dom provides mulitple properties and methods to dynamically change the contenet of the html document using js.
 * 
 * dom properties:document,getElementById(id),getElementsByClassName(className),getElementsByTagName(tagName),
 * queryselector(selector),queryselectorAll(selector),innerhtml,textcontet,style
 * 
 * dom method:createElement(tagName),appendChild(node),removeChild(node),ad
 * 
 * 
 */
/**
